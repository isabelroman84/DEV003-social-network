...
const updateName = (name2) => updateProfile(auth.currentUser, {
  displayName: name2
});
...
const backImg = "data:image/png;base64,";
const Register = (onNavigate2) => {
  ...
  inputPassword.placeholder = "Crea una contrase\xF1a";
  inputPassword.type = "password";
  inputPassword.autocomplete = "off";
  inputRePassword.name = "repeat";
  inputRePassword.placeholder = "Repite tu contrase\xF1a";
  ...
  form.addEventListener("submit", (e) => {
    ...
    if (nameUser === "" && nameUser.length < 5) {
      showMessage("Ingresa un nombre de usuario v\xE1lido");
    } else if (passwordUser !== repeatPass) {
      showMessage("La contrase\xF1a no coincide");
    } else if (nameUser && emailUser && passwordUser && repeatPass) {
      registerUser(emailUser, passwordUser).then((userCredential) => {
        ...
        switch (errorCode) {
          case "auth/invalid-email":
            showMessage("El email no es v\xE1lido");
            break;
          case "auth/user-not-found":
            showMessage("Todav\xEDa no se ha registrado");
            break;
          case "auth/email-already-exists":
            showMessage("El correo ya est\xE1 registrado");
            break;
          case "auth/email-already-in-use":
            showMessage("El correo ya est\xE1 en uso");
            break;
          case "auth/invalid-password":
            showMessage("Contrase\xF1a incorrecta");
            break;
...
const btnGoogleImg = "/DEV003-social-network/assets/google_2x.1811e950.png";
const Login = (onNavigate2) => {
  ...
  register.textContent = "\xBFA\xFAn no tienes una cuenta?";
  registerhref.setAttribute("href", "/register");
  registerhref.textContent = "Reg\xEDstrate";
  ...
  form.addEventListener("submit", (e) => {
    ...
    if (emailUser === "" || passwordUser === "") {
      ...
      loginEmail(emailUser, passwordUser).then((userCredential) => {
        ...
        if (errorCode === "auth/invalid-email") {
          showMessage("La contrase\xF1a es incorrecta");
        } else if (errorCode === "auth/email-already-exists") {
          showMessage("El email ya est\xE1 en uso");
        }
      });
    }
  });
...
const db = oh(app);
const createPost = (post) => Ql(Ta(db, "eventos"), {
...
const q = sl(Ta(db, "eventos"), hl("datePost", "desc"));
const printEvent = (consult) => jl(q, consult);
const getComment = (id2) => Ol(Aa(db, "eventos", id2));
const deleteComment = (id2) => Gl(Aa(db, "eventos", id2));
const updateComment = (id2, post) => Kl(Aa(db, "eventos", id2), { post });
const updateLike = (id2, uid) => Kl(Aa(db, "eventos", id2), {
  like: of(uid)
});
const removeLike = (id2, uid) => Kl(Aa(db, "eventos", id2), {
  like: uf(uid)
});
const editImg = "data:image/png;base64,";
const deleteImg = "data:image/png;base64,";
const starImg = "data:image/png;base64,";
const logoutImg = "data:image/png;base64,";
const Wall = (onNavigate2) => {
  ...
  post.placeholder = "Agrega aqu\xED informaci\xF3n de tu evento (fecha, lugar, valor)";
  ...
  form.addEventListener("submit", (e) => {
    ...
    if (postUser === "") {
      showMessage("Ingresa la descripci\xF3n de tu evento");
      return;
    }
    createPost(postUser).then((docRef) => {
      showMessage("Tu evento se ha creado con \xE9xito");
      form.reset();
    }).catch(() => {
      showMessage("Tu evento no pudo publicarse. Int\xE9ntalo de nuevo");
    });
  });
  printEvent((querySnapshot) => {
    ...
    btnsDelete.forEach((btn) => {
      btn.addEventListener("click", ({ target: { dataset } }) => {
        const confirmDelete = confirm("\xBFRealmente deseas eliminar esta publicaci\xF3n?");
        if (confirmDelete) {
          deleteComment(dataset.id);
          showMessage("Su mensaje ha sido eliminado con \xE9xito");
        }
      });
    });
...
console.log("/DEV003-social-network/");
